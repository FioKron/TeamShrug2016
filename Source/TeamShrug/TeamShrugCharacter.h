...
public:
	...
	*/
	...
	void BeginMineOverlap(AActor* OverlappingActor, FString ActiveBox, float NewIntensity, float NewMinimumCountdown);
	...
	*/
	...
	/**
		The time the Player has to defuse a mine, after initiating defusal:
	*/
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = LimitingFactors)
	float DefusalTime;

	/**
		Quantifiable values related to mechanics:
	*/
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = PostGameFeedback)
	int CurrentScore;
